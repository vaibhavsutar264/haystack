   ...
   return (
      <Page title={title}>
         <CollectionToolbar
            ...
            onDeleteMany={(rows) => {
               Inertia.post(
                  route("admin.messages.delete_many", {
         ...
         <Page.Section>
            ...
            >
               <TableHeader>
                  <Column key={"order_id"} allowsSorting>
                     Order Id
                  </Column>
                  <Column key={"from_name"} allowsSorting>
                     From Name
                  </Column>
                  <Column key={"from_email"} allowsSorting>
                     From Email
                  </Column>
                  <Column key={"from_phone"} allowsSorting>
                     From Mobile no.
                  </Column>
                  <Column key={"receipent_name"} allowsSorting>
                     Receipent Name
                  </Column>
                  <Column key={"receipent_email"} allowsSorting>
                     Receipent Email
                  </Column>
                  <Column key={"receipent_mobile_number"} allowsSorting>
                     Receipent Mobile no.
                  </Column>
                  <Column key={"attachment_url"} allowsSorting>
                     Attachment
                  </Column>
                  <Column key={"sent_at"} allowsSorting>
                     Send at
                  </Column>
                  <Column key={"read_at"} allowsSorting>
                     Read at
                  </Column>
