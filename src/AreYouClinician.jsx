               ...
               <div className="container row">
                  <div className="col-lg-6 col-md-6 d-flex flex-column justify-content-center">
                     ...
                     <div className="mt-lg-3 are-you-clinician-btn">
                        <button className="font-weight-normal text-uppercase me-lg-3 are-you-clinician-btn-left">
                           Book a call
                        </button>
                        <button className="font-weight-normal ms-1 text-uppercase are-you-clinician-btn-left are-you-clinician-btn-right">
                           Know more
                        </button>
                     </div>
                  </div>
